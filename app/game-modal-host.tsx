        ...
        {modal === "vehicles" ? (
          ...
          <>
            ...
            <div className="mobile-help mobile-control-guide">
              ...
              <article><b>EXPLORE ON FOOT</b><p>Slow below 10 KM/H, then tap the yellow EXIT TAXI action beside the passenger’s door. Use the direction pad to walk and turn. RUN, JUMP, and DUCK sit on the right; nearby doors and actions appear above the controls.</p></article>
