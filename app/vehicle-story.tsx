...
export function AccordStory() {
  ...
  return <>
    ...
    {open && <dialog ref={dialog} className="vehicle-story" aria-labelledby="accord-story-title"
      ...
      {/* The supplied poster is preserved as an original, with readable companion copy below. */}
      ...
      <div className="vehicle-story__copy">
        ...
        <a href="/art/vehicle-stories/accord-backstory.png" target="_blank" rel="noreferrer">OPEN ORIGINAL POSTER ↗</a>
      </div>
    </dialog>}
  </>;
}
