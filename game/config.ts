...
/** Soft shoulders lower the speed ceiling over three seconds, not every-frame drag. */
export const OFFROAD_SPEED_LOSS_KMH = 30;
export const OFFROAD_SPEED_LOSS_RATE_KMH = 10;
export const OFFROAD_SPEED_RECOVERY_RATE_KMH = 15;
