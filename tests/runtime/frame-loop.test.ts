...
test("a service pause stops catch-up ticks and discards paused frame time", (context) => {
  ...
  output.useGameRuntime({
    ...
    passengerReviewRef: ref(null), taxiExitRef: ref(null), pickupReminderRef: ref(null), navigationDistanceRef: ref(null), clutchWarningRef: ref(null), fareImpactRef: ref(null),
